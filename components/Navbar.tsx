...
const Navbar = () => {
  return (
    <header className="w-full bg-transparent">
      <nav className="mx-auto flex max-w-7xl items-center justify-center md:justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center pt-5 md:pt-0 gap-3">
          <img
            src="/logo.png"
            alt="Logo"
            width={40}
        ...
        <div className="hidden md:flex">
          <ul className="flex items-center gap-4">
            {[
              { name: "Github", href: "https://github.com/shivendram16053/sleep2earn" },
              { name: "Fitbit", href: "https://store.google.com/category/watches_trackers" },
              { name: "How to earn ?", href: "/howitworks" },
              { name: "Blog", href: "/comingsoon" },
              { name: "Builders", href: "/comingsoon" },
            ].map((link) => (
